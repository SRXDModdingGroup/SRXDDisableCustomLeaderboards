...
namespace SRXDDisableCustomLeaderboards
{
    [BepInPlugin("org.srxdmoddinggroup.disablecustomleaderboards", "disablecustomleaderboards", "1.0.0.0")]
    public class Plugin : BaseUnityPlugin
    {
        private void Awake()
        {
            Logger.LogInfo($"Custom Leaderboards are Disabled!");
        ...
        private class Patches
        {
            ...
            [HarmonyPrefix]
            private static bool patch1(PlayState __0)
            {
                return !__0.TrackInfoRef.IsCustomFile;
            }
        }
    }
}
